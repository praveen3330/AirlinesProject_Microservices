...
*
*/
package com.barclays.transfer.util;
...
public enum TransferEnumError {
	...
	private String typeOfError;
	 ...
	 TransferEnumError(String errorCode, String errorMsg, String typeOfError) {
	 ...
	 public static boolean checkErrorCodes(String errorCodes, String typeOfError) {
		 ...
		 for(TransferEnumError enumObj : TransferEnumError.values()) {
